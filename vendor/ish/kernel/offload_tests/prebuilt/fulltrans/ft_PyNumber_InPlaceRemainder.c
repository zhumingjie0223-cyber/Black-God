...
void ft_PyNumber_InPlaceRemainder(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    cpu->regs[4] = PB_BASE + 0x29a000ULL;
    cpu->regs[3] = 24ULL;
    cpu->regs[4] = cpu->regs[4] + 352ULL;
    cpu->regs[2] = 176ULL;
    ...
    cpu->regs[29] = SP;
    cpu->regs[30] = PB_BASE + 0x23b9bcULL; PB_CALL(2, cpu, tlb, PB_BASE + 0xe270cULL);
    if ((((uint32_t)(cpu->regs[0])))==0) goto L_23b9dc;
    PB_LDR(cpu->regs[1], (cpu->regs[5] + 16));
    if ((cpu->regs[1])==0) goto L_23b9ec;
    PB_LDR(cpu->regs[0], (cpu->regs[5] + 40));
L_23b9cc:
    cpu->regs[2] = cpu->regs[6];
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 16;
    cpu->regs[3] = 1ULL;
    { PB_CALL(3, cpu, tlb, PB_BASE + 0x23ba00ULL); return; };
L_23b9dc:
