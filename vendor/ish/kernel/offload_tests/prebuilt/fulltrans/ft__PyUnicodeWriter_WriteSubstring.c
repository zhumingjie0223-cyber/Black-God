...
void ft__PyUnicodeWriter_WriteSubstring(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    if ((cpu->regs[3])==0) goto L_15562c;
...
L_155568:
    ...
    cpu->regs[5] = 0ULL;
    cpu->regs[30] = PB_BASE + 0x155578ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x11ae68ULL);
...
L_1555b8:
    ...
    if (FLAG_HS) goto L_155550;
L_1555c8:
    cpu->regs[2] = cpu->regs[3];
    cpu->regs[1] = cpu->regs[20];
    cpu->regs[0] = cpu->regs[21];
    cpu->regs[30] = PB_BASE + 0x1555d8ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1dbe60ULL);
    FLAG_CMP(((uint32_t)(cpu->regs[0])), ((uint32_t)(cpu->regs[23])));
    cpu->regs[23] = cpu->regs[0];
    if (FLAG_LS) goto L_155550;
L_1555e4:
    if ((cpu->regs[22])==0) goto L_155600;
    cpu->regs[2] = cpu->regs[23];
    cpu->regs[1] = cpu->regs[22];
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0x1555f8ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x11cba0ULL);
    FLAG_CMP(cpu->regs[0], (uint64_t)(-(int64_t)(1ULL)));
    if (FLAG_EQ) goto L_155588;
L_155600:
    PB_LDR(cpu->regs[0], (cpu->regs[19] + 0));
    cpu->regs[3] = cpu->regs[20];
...
L_155610:
    ...
    if (FLAG_NE) goto L_155534;
    PB_LDR(cpu->regs[19], (SP + 16)); PB_LDR(cpu->regs[20], (SP + 16) + 8);
    PB_LDR(cpu->regs[21], (SP + 32)); PB_LDR(cpu->regs[22], (SP + 32) + 8);
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 64;
    { PB_CALL(4, cpu, tlb, PB_BASE + 0x120700ULL); return; };
L_15562c:
    cpu->regs[0] = 0ULL;
    return;
L_155634:
