...
void ft__PyUnicode_Copy(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    if (!((cpu->regs[0] >> 28) & 1)) goto L_25a35c;
    PB_LDR(cpu->regs[0], (cpu->regs[19] + 32));
    PB_STR((SP + 32), cpu->regs[21]);
    PB_LDR(cpu->regs[21], (cpu->regs[19] + 16));
    if (!((cpu->regs[0] >> 6) & 1)) goto L_25a2f8;
    cpu->regs[1] = 127ULL;
L_25a290:
    cpu->regs[0] = cpu->regs[21];
    cpu->regs[30] = PB_BASE + 0x25a298ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0xdf5a4ULL);
    cpu->regs[20] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_25a348;
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 32));
    if (!((cpu->regs[0] >> 5) & 1)) goto L_25a340;
...
L_25a2b8:
    ...
    if (((cpu->regs[3] >> 5) & 1)) goto L_25a32c;
    PB_LDR(cpu->regs[1], (cpu->regs[19] + 56));
L_25a2c4:
    cpu->regs[2] = ((cpu->regs[3] >> 2) & 0x7ULL);
    cpu->regs[2] = cpu->regs[2] * cpu->regs[21];
    FLAG_CMP(cpu->regs[1], cpu->regs[0]);
    if (FLAG_LS) goto L_25a318;
    cpu->regs[3] = cpu->regs[0] + cpu->regs[2];
    FLAG_CMP(cpu->regs[1], cpu->regs[3]);
    if (FLAG_LO) goto L_25a328;
L_25a2e0:
    cpu->regs[30] = PB_BASE + 0x25a2e4ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x7c090ULL);
...
L_25a35c:
    ...
    cpu->regs[20] = 0ULL;
    cpu->regs[30] = PB_BASE + 0x25a370ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x9bb50ULL);
    goto L_25a2e8;
    /* nop */
    /* nop */
    /* nop */
