...
void ft__PyState_AddModule(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    cpu->regs[3] = cpu->regs[2];
    cpu->regs[2] = cpu->regs[1];
    cpu->regs[1] = cpu->regs[3];
    if ((cpu->regs[3])==0) goto L_a0c44;
    PB_LDR(cpu->regs[4], (cpu->regs[3] + 72));
    if ((cpu->regs[4])==0) goto L_a0c3c;
    ...
    cpu->regs[30] = PB_BASE + 0xa0c30ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x1d5980ULL);
    cpu->regs[0] = 4294967295ULL;
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 16;
    return;
L_a0c3c:
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 16));
    { PB_CALL(2, cpu, tlb, PB_BASE + 0x190d00ULL); return; };
L_a0c44:
    cpu->regs[0] = 4294967295ULL;
    return;
    if ((cpu->regs[1])==0) goto L_a0c80;
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 952));
    if ((cpu->regs[0])==0) goto L_a0c8c;
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 16));
    FLAG_CMP(cpu->regs[2], cpu->regs[1]);
    if (FLAG_LT) goto L_a0c98;
...
L_a0ca0:
    ...
    cpu->regs[30] = PB_BASE + 0xa0cb8ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x91ebcULL);
L_a0cb8:
