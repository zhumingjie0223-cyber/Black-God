...
void ft_PyType_FromSpecWithBases(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x1ab454ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1085d0ULL);
    if ((cpu->regs[0])==0) goto L_1ab46c;
    cpu->regs[1] = 8ULL;
