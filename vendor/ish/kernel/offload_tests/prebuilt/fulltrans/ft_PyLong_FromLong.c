...
void ft_PyLong_FromLong(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
...
L_e2660:
    ...
    if (FLAG_HI) goto L_e2684;
    cpu->regs[0] = cpu->regs[19];
    PB_LDR(cpu->regs[19], (SP + 16)); PB_LDR(cpu->regs[20], (SP + 16) + 8);
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 48;
    { PB_CALL(1, cpu, tlb, PB_BASE + 0xe3e84ULL); return; };
L_e2684:
    FLAG_CMP(cpu->regs[19], 0ULL);
    PB_STR((SP + 32), cpu->regs[21]); PB_STR((SP + 32) + 8, cpu->regs[22]);
    cpu->regs[20] = (FLAG_LT) ? ((uint64_t)(-(int64_t)cpu->regs[19])) : cpu->regs[19];
    cpu->regs[22] = cpu->regs[20] >> 60;
    if ((cpu->regs[22])!=0) goto L_e26f4;
    cpu->regs[0] = 2ULL;
    cpu->regs[21] = cpu->regs[0];
L_e26a0:
    cpu->regs[30] = PB_BASE + 0xe26a4ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0xe1608ULL);
    if ((cpu->regs[0])==0) goto L_e26ec;
    cpu->regs[21] = ((cpu->regs[21] & 0x3ULL) << 3);
    cpu->regs[1] = cpu->regs[0] + 28ULL;
    if (((cpu->regs[19] >> 63) & 1)) goto L_e26dc;
    cpu->regs[2] = ((uint32_t)(cpu->regs[20] & 1073741823ULL));
...
L_e26bc:
    ...
    PB_STRW((cpu->regs[1] + 0), cpu->regs[20]);
    if ((cpu->regs[22])==0) goto L_e26ec;
...
L_e26f4:
    ...
    if (FLAG_NE) goto L_e2720;
L_e2718:
    cpu->regs[0] = 1ULL;
L_e271c:
    return;
L_e2720:
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 344));
    if ((cpu->regs[2])==0) goto L_e279c;
    PB_LDR(cpu->regs[3], (cpu->regs[2] + 16));
    cpu->regs[0] = 0ULL;
    FLAG_CMP(cpu->regs[3], 0ULL);
    if (FLAG_LE) goto L_e271c;
    PB_LDR(cpu->regs[4], (cpu->regs[2] + 24));
    FLAG_CMP(cpu->regs[1], cpu->regs[4]);
    if (FLAG_EQ) goto L_e2718;
    FLAG_CMP(cpu->regs[3], 1ULL);
    if (FLAG_EQ) goto L_e271c;
    ...
    cpu->regs[0] = 3ULL;
L_e277c:
    PB_LDR(cpu->regs[4], (cpu->regs[2] + (cpu->regs[0] << 3)));
    cpu->regs[0] = cpu->regs[0] + 1ULL;
    FLAG_CMP(cpu->regs[1], cpu->regs[4]);
    if (FLAG_EQ) goto L_e2718;
    FLAG_CMP(cpu->regs[3], cpu->regs[0]);
    if (FLAG_NE) goto L_e277c;
    cpu->regs[0] = 0ULL;
    return;
L_e279c:
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 256));
    if ((cpu->regs[0])==0) goto L_e27b4;
    FLAG_CMP(cpu->regs[1], cpu->regs[0]);
    if (FLAG_NE) goto L_e279c;
    cpu->regs[0] = 1ULL;
    goto L_e271c;
L_e27b4:
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
