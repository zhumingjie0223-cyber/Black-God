...
void ft_PyBytes_FromString(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x1a4ba8ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x7c0d0ULL);
    cpu->regs[2] = 18446744073709551582ULL;
    cpu->regs[2] = (cpu->regs[2] & ~(0xffffULL << 48)) | ((0x7fffULL & 0xffff) << 48);
    FLAG_CMP(cpu->regs[0], cpu->regs[2]);
    if (FLAG_HI) goto L_1a4c90;
    cpu->regs[19] = cpu->regs[0];
    if ((cpu->regs[0])!=0) goto L_1a4bf0;
    cpu->regs[20] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[20], (cpu->regs[20] + 2248));
    PB_LDRW(cpu->regs[0], (cpu->regs[20] + 11432));
    cpu->regs[0] = ((uint32_t)(cpu->regs[0] + 1ULL)); FLAG_CMP(cpu->regs[0], 0);
    if (FLAG_NE) goto L_1a4c58;
L_1a4bd4:
    cpu->regs[0] = 11432ULL;
...
L_1a4bf0:
    ...
    if (FLAG_EQ) goto L_1a4c60;
    cpu->regs[0] = cpu->regs[0] + 33ULL;
    cpu->regs[30] = PB_BASE + 0x1a4c00ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0xd8e60ULL);
    cpu->regs[20] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_1a4cb0;
    cpu->regs[1] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[1], (cpu->regs[1] + 2392));
    cpu->regs[30] = PB_BASE + 0x1a4c14ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0xd93e0ULL);
    ...
    if (FLAG_HS) goto L_1a4c44;
    cpu->regs[1] = cpu->regs[0] + cpu->regs[2];
    FLAG_CMP(cpu->regs[21], cpu->regs[1]);
    if (FLAG_LO) goto L_1a4c54;
L_1a4c38:
    cpu->regs[1] = cpu->regs[21];
    cpu->regs[30] = PB_BASE + 0x1a4c40ULL; PB_CALL(4, cpu, tlb, PB_BASE + 0x7c090ULL);
    goto L_1a4bdc;
L_1a4c44:
    if (FLAG_LS) goto L_1a4c38;
    cpu->regs[1] = cpu->regs[21] + cpu->regs[2];
    FLAG_CMP(cpu->regs[0], cpu->regs[1]);
    if (FLAG_HS) goto L_1a4c38;
L_1a4c54:
    __builtin_trap();
L_1a4c58:
    PB_STRW((cpu->regs[20] + 11432), cpu->regs[0]);
    goto L_1a4bd4;
L_1a4c60:
    PB_LDRB(cpu->regs[0], (cpu->regs[21] + 0));
    cpu->regs[1] = 11472ULL;
    cpu->regs[3] = 48ULL;
    cpu->regs[2] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[2], (cpu->regs[2] + 2248));
    cpu->regs[0] = cpu->regs[1] + (uint64_t)(uint32_t)cpu->regs[0] * (uint64_t)(uint32_t)cpu->regs[3];
    cpu->regs[20] = cpu->regs[0] + cpu->regs[2];
    PB_LDRW(cpu->regs[1], (cpu->regs[2] + cpu->regs[0]));
    cpu->regs[1] = ((uint32_t)(cpu->regs[1] + 1ULL)); FLAG_CMP(cpu->regs[1], 0);
    if (FLAG_EQ) goto L_1a4bdc;
...
L_1a4c90:
    ...
    cpu->regs[30] = PB_BASE + 0x1a4cacULL; PB_CALL(5, cpu, tlb, PB_BASE + 0x1d5940ULL);
    goto L_1a4bdc;
L_1a4cb0:
    PB_LDR(cpu->regs[21], (SP + 32));
    PB_LDR(cpu->regs[19], (SP + 16)); PB_LDR(cpu->regs[20], (SP + 16) + 8);
