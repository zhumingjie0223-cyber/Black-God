...
void ft_PyErr_GetExcInfo(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x8f308ULL; PB_CALL(1, cpu, tlb, cpu->regs[5]);
    ...
    { PB_CALL(2, cpu, tlb, PB_BASE + 0x8f164ULL); return; };
}
