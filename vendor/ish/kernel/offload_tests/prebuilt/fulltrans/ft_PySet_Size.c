...
void ft_PySet_Size(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    PB_LDR(cpu->regs[6], (cpu->regs[0] + 8));
    cpu->regs[5] = cpu->regs[0];
    cpu->regs[7] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[7], (cpu->regs[7] + 2592));
...
L_1b6b3c:
    ...
    cpu->regs[29] = SP;
    cpu->regs[30] = PB_BASE + 0x1b6b4cULL; PB_CALL(1, cpu, tlb, PB_BASE + 0xdd1a8ULL);
    if ((((uint32_t)(cpu->regs[0])))==0) goto L_1b6b5c;
L_1b6b50:
...
L_1b6b5c:
    ...
    cpu->regs[0] = cpu->regs[6];
    cpu->regs[30] = PB_BASE + 0x1b6b68ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0xdd1a8ULL);
    if ((((uint32_t)(cpu->regs[0])))!=0) goto L_1b6b50;
    cpu->regs[0] = PB_BASE + 0x28a000ULL;
    cpu->regs[1] = 2288ULL;
    cpu->regs[0] = cpu->regs[0] + 1456ULL;
    cpu->regs[30] = PB_BASE + 0x1b6b7cULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x9bb50ULL);
