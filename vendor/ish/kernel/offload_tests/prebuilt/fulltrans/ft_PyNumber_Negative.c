...
void ft_PyNumber_Negative(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP += -16; PB_STR(SP, cpu->regs[29]); PB_STR(SP + 8, cpu->regs[30]);
    cpu->regs[29] = SP;
    if ((cpu->regs[0])==0) goto L_13489c;
    PB_LDR(cpu->regs[4], (cpu->regs[0] + 8));
    PB_LDR(cpu->regs[2], (cpu->regs[4] + 96));
    if ((cpu->regs[2])==0) goto L_1348a8;
    PB_LDR(cpu->regs[3], (cpu->regs[2] + 48));
    if ((cpu->regs[3])==0) goto L_1348a8;
    cpu->regs[2] = PB_BASE + 0x134000ULL;
    cpu->regs[2] = cpu->regs[2] + 2784ULL;
    FLAG_CMP(cpu->regs[3], cpu->regs[2]);
    if (FLAG_NE) goto L_134888;
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 16));
    FLAG_CMP(cpu->regs[2], 15ULL);
    if (FLAG_HI) goto L_134860;
...
L_134844:
    ...
    if (FLAG_HI) goto L_134894;
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 16;
    { PB_CALL(1, cpu, tlb, PB_BASE + 0xe3e84ULL); return; };
L_134860:
    cpu->regs[30] = PB_BASE + 0x134864ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x170a04ULL);
    if ((cpu->regs[0])==0) goto L_13483c;
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 16));
    cpu->regs[1] = 2ULL;
...
L_134894:
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 16;
    { PB_CALL(3, cpu, tlb, PB_BASE + 0x169eacULL); return; };
L_13489c:
    cpu->regs[30] = PB_BASE + 0x1348a0ULL; PB_CALL(4, cpu, tlb, PB_BASE + 0x96bd4ULL);
    cpu->regs[0] = 0ULL;
    goto L_13483c;
L_1348a8:
    ...
    cpu->regs[30] = PB_BASE + 0x1348c4ULL; PB_CALL(5, cpu, tlb, PB_BASE + 0x11f220ULL);
    cpu->regs[0] = 0ULL;
    goto L_13483c;
}
