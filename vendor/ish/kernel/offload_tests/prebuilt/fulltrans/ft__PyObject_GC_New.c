...
void ft__PyObject_GC_New(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0xd8da4ULL; PB_CALL(1, cpu, tlb, cpu->regs[5]);
    ...
    if (FLAG_HI) goto L_d8e3c;
    cpu->regs[19] = cpu->regs[19] << 3;
    cpu->regs[1] = cpu->regs[1] + cpu->regs[19]; FLAG_CMP(cpu->regs[1], 0);
    if (FLAG_LT) goto L_d8e3c;
    ...
    cpu->regs[30] = PB_BASE + 0xd8dd4ULL; PB_CALL(2, cpu, tlb, cpu->regs[2]);
    if ((cpu->regs[0])==0) goto L_d8e3c;
    PB_STR((cpu->regs[0] + 0), 0ULL); PB_STR((cpu->regs[0] + 0) + 8, 0ULL);
    cpu->regs[19] = cpu->regs[0] + cpu->regs[19];
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0xd8de8ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0xd9340ULL);
    if ((cpu->regs[19])==0) goto L_d8e4c;
L_d8dec:
    PB_LDR(cpu->regs[0], (cpu->regs[20] + 168));
    PB_STR((cpu->regs[19] + 8), cpu->regs[20]);
    if (((cpu->regs[0] >> 9) & 1)) goto L_d8e1c;
L_d8df8:
    PB_LDRW(cpu->regs[0], (cpu->regs[21] + 2708));
    if ((((uint32_t)(cpu->regs[0])))!=0) goto L_d8e30;
L_d8e00:
    cpu->regs[0] = 1ULL;
...
L_d8e1c:
    ...
    if (FLAG_EQ) goto L_d8df8;
    PB_STRW((cpu->regs[20] + 0), cpu->regs[0]);
    goto L_d8df8;
L_d8e30:
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0xd8e38ULL; PB_CALL(4, cpu, tlb, PB_BASE + 0x98264ULL);
    goto L_d8e00;
L_d8e3c:
    cpu->regs[0] = cpu->regs[22];
    cpu->regs[30] = PB_BASE + 0xd8e44ULL; PB_CALL(5, cpu, tlb, PB_BASE + 0x22d7a8ULL);
    cpu->regs[19] = cpu->regs[0];
    if ((cpu->regs[0])!=0) goto L_d8e54;
L_d8e4c:
    cpu->regs[19] = 0ULL;
    goto L_d8e08;
L_d8e54:
