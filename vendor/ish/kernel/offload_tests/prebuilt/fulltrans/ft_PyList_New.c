...
void ft_PyList_New(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP += -48; PB_STR(SP, cpu->regs[29]); PB_STR(SP + 8, cpu->regs[30]);
    cpu->regs[29] = SP;
    PB_STR((SP + 16), cpu->regs[19]); PB_STR((SP + 16) + 8, cpu->regs[20]);
    if (((cpu->regs[0] >> 63) & 1)) goto L_d8d34;
...
L_d8c84:
    ...
    cpu->regs[30] = PB_BASE + 0xd8cacULL; PB_CALL(3, cpu, tlb, cpu->regs[3]);
    PB_STR((cpu->regs[19] + 24), cpu->regs[0]);
    if ((cpu->regs[0])==0) goto L_d8d10;
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[1], (cpu->regs[0] + 2160));
    cpu->regs[0] = cpu->regs[0] + 2160ULL;
    cpu->regs[30] = PB_BASE + 0xd8cc4ULL; PB_CALL(4, cpu, tlb, cpu->regs[1]);
...
L_d8ce0:
    ...
    cpu->regs[30] = PB_BASE + 0xd8cecULL; PB_CALL(5, cpu, tlb, PB_BASE + 0xd8d60ULL);
    cpu->regs[19] = cpu->regs[0];
    if ((cpu->regs[0])!=0) goto L_d8c28;
    PB_LDR(cpu->regs[21], (SP + 32));
    cpu->regs[19] = 0ULL;
    goto L_d8c74;
L_d8d00:
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0xd8d08ULL; PB_CALL(6, cpu, tlb, PB_BASE + 0x98264ULL);
    goto L_d8c20;
L_d8d0c:
    PB_STR((cpu->regs[19] + 24), 0ULL);
L_d8d10:
    PB_LDR(cpu->regs[0], (cpu->regs[19] + 0));
    if (((cpu->regs[0] >> 31) & 1)) goto L_d8d24;
    cpu->regs[0] = cpu->regs[0] - 1ULL;
    PB_STR((cpu->regs[19] + 0), cpu->regs[0]);
    if ((cpu->regs[0])==0) goto L_d8d4c;
L_d8d24:
    PB_LDR(cpu->regs[21], (SP + 32));
    PB_LDR(cpu->regs[19], (SP + 16)); PB_LDR(cpu->regs[20], (SP + 16) + 8);
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 48;
...
L_d8d34:
    ...
    cpu->regs[19] = 0ULL;
    cpu->regs[30] = PB_BASE + 0xd8d48ULL; PB_CALL(8, cpu, tlb, PB_BASE + 0x9bb50ULL);
    goto L_d8c74;
L_d8d4c:
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0xd8d54ULL; PB_CALL(9, cpu, tlb, PB_BASE + 0xdcac8ULL);
    goto L_d8d24;
    /* nop */
    /* nop */
}
