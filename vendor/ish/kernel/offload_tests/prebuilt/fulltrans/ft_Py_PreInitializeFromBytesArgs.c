...
void ft_Py_PreInitializeFromBytesArgs(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 64ULL;
    ...
    PB_STRW((SP + 36), 0ULL);
    cpu->regs[30] = PB_BASE + 0x9690cULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x17ad8cULL);
    ...
    cpu->regs[1] = 0ULL;
    if (FLAG_EQ) goto L_9692c;
    cpu->regs[30] = PB_BASE + 0x9692cULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x7c170ULL);
L_9692c:
