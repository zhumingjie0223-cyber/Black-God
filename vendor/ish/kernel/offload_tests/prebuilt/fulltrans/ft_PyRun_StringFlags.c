...
void ft_PyRun_StringFlags(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x1ddb2cULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x193da0ULL);
    cpu->regs[19] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_1ddb94;
    ...
    cpu->regs[30] = PB_BASE + 0x1ddb5cULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x193e64ULL);
    cpu->regs[20] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_1ddb84;
    ...
    cpu->regs[30] = PB_BASE + 0x1ddb80ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x1e33e0ULL);
    cpu->regs[20] = cpu->regs[0];
L_1ddb84:
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0x1ddb8cULL; PB_CALL(4, cpu, tlb, PB_BASE + 0x1c12acULL);
