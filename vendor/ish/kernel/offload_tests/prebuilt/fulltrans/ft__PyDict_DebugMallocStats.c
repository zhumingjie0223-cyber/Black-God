...
void ft__PyDict_DebugMallocStats(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x8fb74ULL; PB_CALL(1, cpu, tlb, cpu->regs[1]);
    ...
    PB_LDRW(cpu->regs[2], (cpu->regs[2] + 1296));
