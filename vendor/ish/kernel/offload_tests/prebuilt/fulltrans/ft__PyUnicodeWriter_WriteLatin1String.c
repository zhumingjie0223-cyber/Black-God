...
void ft__PyUnicodeWriter_WriteLatin1String(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[22] = cpu->regs[1] + cpu->regs[2];
    cpu->regs[1] = cpu->regs[22];
    cpu->regs[21] = cpu->regs[2];
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0x98a24ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x196180ULL);
    PB_LDRW(cpu->regs[1], (cpu->regs[20] + 20));
    cpu->regs[2] = cpu->regs[0];
    FLAG_CMP(((uint32_t)(cpu->regs[1])), ((uint32_t)(cpu->regs[0])));
    if (FLAG_LO) goto L_98a6c;
    PB_LDR(cpu->regs[0], (cpu->regs[20] + 24)); PB_LDR(cpu->regs[1], (cpu->regs[20] + 24) + 8);
    cpu->regs[0] = cpu->regs[0] - cpu->regs[1];
    FLAG_CMP(cpu->regs[0], cpu->regs[21]);
    if (FLAG_LT) goto L_98a6c;
L_98a44:
    ...
    if (!((cpu->regs[1] >> 5) & 1)) goto L_98a88;
    ...
    goto L_98a8c;
L_98a6c:
    if ((cpu->regs[21])==0) goto L_98a44;
    cpu->regs[1] = cpu->regs[21];
    cpu->regs[0] = cpu->regs[20];
    cpu->regs[30] = PB_BASE + 0x98a7cULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x11cba0ULL);
    FLAG_CMP(cpu->regs[0], (uint64_t)(-(int64_t)(1ULL)));
    if (FLAG_NE) goto L_98a44;
    goto L_98b30;
L_98a88:
    PB_LDR(cpu->regs[3], (cpu->regs[3] + 56));
L_98a8c:
    FLAG_CMP(((uint32_t)(cpu->regs[2])), ((uint32_t)(2ULL)));
    if (FLAG_EQ) goto L_98ad8;
    FLAG_CMP(((uint32_t)(cpu->regs[2])), ((uint32_t)(4ULL)));
    if (FLAG_EQ) goto L_98afc;
    cpu->regs[0] = cpu->regs[3] + cpu->regs[0];
    FLAG_CMP(cpu->regs[19], cpu->regs[0]);
    if (FLAG_LS) goto L_98ab8;
    cpu->regs[1] = cpu->regs[0] + cpu->regs[21];
    FLAG_CMP(cpu->regs[19], cpu->regs[1]);
    if (FLAG_HS) goto L_98ac8;
    goto L_98ac4;
L_98ab8:
    if (FLAG_HS) goto L_98ac8;
    FLAG_CMP(cpu->regs[22], cpu->regs[0]);
    if (FLAG_LS) goto L_98ac8;
L_98ac4:
    __builtin_trap();
L_98ac8:
    cpu->regs[1] = cpu->regs[19];
    cpu->regs[2] = cpu->regs[21];
    cpu->regs[30] = PB_BASE + 0x98ad4ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x7c090ULL);
    goto L_98b20;
L_98ad8:
...
L_98ae0:
    ...
    if (FLAG_LS) goto L_98b20;
    PB_LDRB(cpu->regs[2], (cpu->regs[19] + cpu->regs[1]));
    PB_STRH((cpu->regs[0] + (cpu->regs[1] << 1)), cpu->regs[2]);
    cpu->regs[1] = cpu->regs[1] + 1ULL;
    goto L_98ae0;
L_98afc:
    cpu->regs[0] = cpu->regs[3] + (cpu->regs[0] << 2);
    cpu->regs[1] = 0ULL;
L_98b04:
    cpu->regs[2] = cpu->regs[19] + cpu->regs[1];
    FLAG_CMP(cpu->regs[22], cpu->regs[2]);
    if (FLAG_LS) goto L_98b20;
    PB_LDRB(cpu->regs[2], (cpu->regs[19] + cpu->regs[1]));
    PB_STRW((cpu->regs[0] + (cpu->regs[1] << 2)), cpu->regs[2]);
    cpu->regs[1] = cpu->regs[1] + 1ULL;
    goto L_98b04;
L_98b20:
