...
void ft_PyLong_AsSsize_t(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP += -16; PB_STR(SP, cpu->regs[29]); PB_STR(SP + 8, cpu->regs[30]);
    cpu->regs[29] = SP;
    if ((cpu->regs[0])==0) goto L_e5374;
    PB_LDR(cpu->regs[1], (cpu->regs[0] + 8));
    PB_LDR(cpu->regs[1], (cpu->regs[1] + 168));
    if (!((cpu->regs[1] >> 24) & 1)) goto L_e5354;
    PB_LDR(cpu->regs[1], (cpu->regs[0] + 16));
    FLAG_CMP(cpu->regs[1], 15ULL);
    if (FLAG_HI) goto L_e5280;
...
L_e5278:
    ...
    return;
L_e5280:
    cpu->regs[5] = cpu->regs[1] >> 3;
    cpu->regs[4] = cpu->regs[0] + (cpu->regs[5] << 2);
    PB_LDRW(cpu->regs[2], (cpu->regs[4] + 20));
    FLAG_CMP(0ULL, cpu->regs[2]);
    if (FLAG_NE) goto L_e5334;
    PB_LDRW(cpu->regs[3], (cpu->regs[4] + 16));
    cpu->regs[3] = cpu->regs[3] | (cpu->regs[2] << 30);
    ...
    if (FLAG_EQ) goto L_e5310;
    PB_LDRW(cpu->regs[2], (cpu->regs[4] + 12));
    cpu->regs[2] = cpu->regs[2] | (cpu->regs[3] << 30);
    FLAG_CMP(cpu->regs[3], cpu->regs[2]);
    if (FLAG_NE) goto L_e5334;
    cpu->regs[3] = cpu->regs[5] - 4ULL;
    FLAG_CMP(cpu->regs[5], 3ULL);
    if (FLAG_EQ) goto L_e531c;
    PB_LDRW(cpu->regs[4], (cpu->regs[4] + 8));
    cpu->regs[4] = cpu->regs[4] | (cpu->regs[2] << 30);
...
L_e52ec:
    ...
    if (FLAG_EQ) goto L_e531c;
    PB_LDRW(cpu->regs[4], (cpu->regs[0] + (cpu->regs[3] << 2)));
    cpu->regs[4] = cpu->regs[4] | (cpu->regs[2] << 30);
    FLAG_CMP(cpu->regs[2], cpu->regs[4]);
    if (FLAG_NE) goto L_e5334;
    cpu->regs[2] = cpu->regs[4];
...
L_e531c:
    ...
    if (!((cpu->regs[2] >> 63) & 1)) goto L_e5310;
    FLAG_CMP(((uint32_t)(cpu->regs[1])), ((uint32_t)(0ULL)));
    cpu->regs[0] = 9223372036854775808ULL;
    if (FLAG_LT) { FLAG_CMP(cpu->regs[2], cpu->regs[0]); } else { FLAG_CMP(0, 1); }
    if (FLAG_EQ) goto L_e5278;
L_e5334:
    ...
    cpu->regs[30] = PB_BASE + 0xe534cULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x1d5940ULL);
...
L_e5354:
    ...
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 0));
    cpu->regs[30] = PB_BASE + 0xe536cULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1d5940ULL);
    cpu->regs[0] = 18446744073709551615ULL;
    goto L_e5278;
L_e5374:
    ...
    cpu->regs[30] = PB_BASE + 0xe5384ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x9bb50ULL);
    cpu->regs[0] = 18446744073709551615ULL;
    goto L_e5278;
}
