...
void ft_PyObject_CallNoArgs(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 48ULL;
    ...
    cpu->regs[30] = PB_BASE + 0x1c7250ULL; PB_CALL(1, cpu, tlb, cpu->regs[2]);
    ...
    if (!((cpu->regs[0] >> 11) & 1)) goto L_1c72fc;
    ...
    if (FLAG_LO) goto L_1c7340;
    FLAG_CMP(cpu->regs[0], cpu->regs[1]);
    if (FLAG_HS) goto L_1c72a4;
    cpu->regs[0] = cpu->regs[0] + 8ULL;
    FLAG_CMP(SP, cpu->regs[0]);
    if (FLAG_LO) goto L_1c7340;
L_1c72a4:
    PB_LDR(cpu->regs[4], (cpu->regs[19] + cpu->regs[3]));
    if ((cpu->regs[4])==0) goto L_1c72fc;
    cpu->regs[3] = 0ULL;
    cpu->regs[2] = 0ULL;
    cpu->regs[1] = 0ULL;
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0x1c72c0ULL; PB_CALL(2, cpu, tlb, cpu->regs[4]);
...
L_1c733c:
    cpu->regs[30] = PB_BASE + 0x1c7340ULL; PB_CALL(5, cpu, tlb, PB_BASE + 0x7c170ULL);
L_1c7340:
    __builtin_trap();
}
