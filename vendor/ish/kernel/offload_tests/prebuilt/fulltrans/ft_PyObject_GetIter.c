...
void ft_PyObject_GetIter(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP += -32; PB_STR(SP, cpu->regs[29]); PB_STR(SP + 8, cpu->regs[30]);
    cpu->regs[29] = SP;
    PB_STR((SP + 16), cpu->regs[19]); PB_STR((SP + 16) + 8, cpu->regs[20]);
    PB_LDR(cpu->regs[20], (cpu->regs[0] + 8));
    PB_LDR(cpu->regs[1], (cpu->regs[20] + 216));
    if ((cpu->regs[1])==0) goto L_e7ed8;
    cpu->regs[30] = PB_BASE + 0xe7ea4ULL; PB_CALL(1, cpu, tlb, cpu->regs[1]);
    cpu->regs[19] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_e7f00;
    PB_LDR(cpu->regs[2], (cpu->regs[19] + 8));
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 2208));
    PB_LDR(cpu->regs[1], (cpu->regs[2] + 224));
    FLAG_CMP(cpu->regs[1], 0ULL);
    if (FLAG_NE) { FLAG_CMP(cpu->regs[1], cpu->regs[0]); } else { FLAG_CMP(0, 0); }
    if (FLAG_EQ) goto L_e7f18;
L_e7ec8:
...
L_e7ed8:
    cpu->regs[19] = cpu->regs[0];
    cpu->regs[30] = PB_BASE + 0xe7ee0ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1fa720ULL);
    if ((((uint32_t)(cpu->regs[0])))!=0) goto L_e7f08;
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
    ...
    cpu->regs[30] = PB_BASE + 0xe7f00ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x11f220ULL);
L_e7f00:
    cpu->regs[19] = 0ULL;
    goto L_e7ec8;
L_e7f08:
    ...
    PB_LDR(cpu->regs[19], (SP + 16)); PB_LDR(cpu->regs[20], (SP + 16) + 8);
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 32;
    { PB_CALL(4, cpu, tlb, PB_BASE + 0x1fa944ULL); return; };
L_e7f18:
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 2736));
    cpu->regs[1] = PB_BASE + 0x284000ULL;
    ...
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 0));
    cpu->regs[30] = PB_BASE + 0xe7f34ULL; PB_CALL(5, cpu, tlb, PB_BASE + 0x11f220ULL);
    PB_LDR(cpu->regs[0], (cpu->regs[19] + 0));
    if (((cpu->regs[0] >> 31) & 1)) goto L_e7f00;
    cpu->regs[0] = cpu->regs[0] - 1ULL;
    PB_STR((cpu->regs[19] + 0), cpu->regs[0]);
    if ((cpu->regs[0])!=0) goto L_e7f00;
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[19] = 0ULL;
    cpu->regs[30] = PB_BASE + 0xe7f54ULL; PB_CALL(6, cpu, tlb, PB_BASE + 0xdcac8ULL);
    goto L_e7ec8;
    /* nop */
    /* nop */
    SP += -32; PB_STR(SP, cpu->regs[29]); PB_STR(SP + 8, cpu->regs[30]);
    ...
    if (!((cpu->regs[0] >> 26) & 1)) goto L_e8040;
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 3416));
    cpu->regs[30] = PB_BASE + 0xe7f88ULL; PB_CALL(7, cpu, tlb, PB_BASE + 0xd8d60ULL);
    cpu->regs[1] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_e8050;
    PB_LDRW(cpu->regs[0], (cpu->regs[19] + 0));
    PB_STR((cpu->regs[1] + 16), 0ULL);
    cpu->regs[3] = ((uint32_t)(cpu->regs[0] + 1ULL)); FLAG_CMP(cpu->regs[3], 0);
    if (FLAG_EQ) goto L_e7ff8;
    cpu->regs[4] = cpu->tls_ptr;
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 2160));
    cpu->regs[0] = cpu->regs[0] + 2160ULL;
    cpu->regs[30] = PB_BASE + 0xe7fb4ULL; PB_CALL(8, cpu, tlb, cpu->regs[2]);
...
L_e7ff8:
    ...
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 2160));
    cpu->regs[0] = cpu->regs[0] + 2160ULL;
    cpu->regs[30] = PB_BASE + 0xe800cULL; PB_CALL(9, cpu, tlb, cpu->regs[2]);
    PB_LDR(cpu->regs[2], (cpu->regs[1] + -8));
...
L_e8040:
    ...
    cpu->regs[30] = PB_BASE + 0xe8050ULL; PB_CALL(10, cpu, tlb, PB_BASE + 0x9bb50ULL);
L_e8050:
    cpu->regs[1] = 0ULL;
    goto L_e7fe8;
    /* nop */
