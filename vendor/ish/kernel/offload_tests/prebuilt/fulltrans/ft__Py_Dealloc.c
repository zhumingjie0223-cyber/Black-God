...
void ft__Py_Dealloc(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    if ((cpu->regs[1])==0) goto L_dcc70;
    PB_LDR(cpu->regs[2], (cpu->regs[20] + -8));
    cpu->regs[3] = PB_BASE + 0xdc000ULL;
...
L_dcc34:
    ...
    if ((cpu->regs[3])!=0) goto L_dcb98;
    PB_LDR(cpu->regs[1], (cpu->regs[0] + 8));
    cpu->regs[19] = cpu->regs[19] - 1ULL;
    PB_LDR(cpu->regs[1], (cpu->regs[1] + 48));
    cpu->regs[30] = PB_BASE + 0xdcc4cULL; PB_CALL(4, cpu, tlb, cpu->regs[1]);
    PB_LDR(cpu->regs[1], (cpu->regs[20] + 24));
    FLAG_CMP(cpu->regs[19], (uint64_t)(-(int64_t)(1ULL)));
    if (FLAG_NE) goto L_dcb84;
    goto L_dcba4;
L_dcc5c:
    ...
    cpu->regs[30] = PB_BASE + 0xdcc68ULL; PB_CALL(5, cpu, tlb, cpu->regs[1]);
    if ((cpu->regs[21])!=0) goto L_dcc08;
    goto L_dcc24;
L_dcc70:
    PB_LDR(cpu->regs[1], (cpu->regs[20] + 8));
    cpu->regs[0] = PB_BASE + 0xdc000ULL;
    cpu->regs[0] = cpu->regs[0] + 2784ULL;
    PB_LDR(cpu->regs[1], (cpu->regs[1] + 48));
    FLAG_CMP(cpu->regs[1], cpu->regs[0]);
    if (FLAG_EQ) goto L_dcb3c;
L_dcc88:
    cpu->regs[22] = cpu->tls_ptr;
    cpu->regs[21] = 0ULL;
    goto L_dcb70;
...
L_dcc9c:
    ...
    cpu->regs[30] = PB_BASE + 0xdccb4ULL; PB_CALL(6, cpu, tlb, cpu->regs[2]);
    PB_LDR(cpu->regs[2], (cpu->regs[21] + 160));
L_dccb8:
    cpu->regs[0] = cpu->regs[2];
    if ((cpu->regs[2])!=0) goto L_dcc9c;
...
L_dccd0:
    ...
    PB_STR((cpu->regs[1] + 8), cpu->regs[20]);
    goto L_dcc24;
L_dccec:
    cpu->regs[30] = PB_BASE + 0xdccf0ULL; PB_CALL(7, cpu, tlb, PB_BASE + 0x7c39cULL);
