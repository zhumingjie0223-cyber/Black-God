...
void ft_PyLong_FromSsize_t(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
...
L_e2000:
    ...
    if (((cpu->regs[19] >> 63) & 1)) goto L_e2088;
    cpu->regs[21] = cpu->regs[19] >> 30;
    if ((cpu->regs[21])!=0) goto L_e2030;
    cpu->regs[0] = 1ULL;
    cpu->regs[30] = PB_BASE + 0xe2018ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0xe1608ULL);
    if ((cpu->regs[0])==0) goto L_e20e8;
    cpu->regs[1] = 8ULL;
...
L_e2038:
    ...
    cpu->regs[30] = PB_BASE + 0xe2054ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0xe1608ULL);
    if ((cpu->regs[0])==0) goto L_e20e4;
    if ((((uint32_t)(cpu->regs[23])))!=0) goto L_e20c4;
...
L_e2068:
    ...
    if ((cpu->regs[22])!=0) goto L_e20b4;
    PB_LDR(cpu->regs[23], (SP + 48));
    PB_LDR(cpu->regs[21], (SP + 32)); PB_LDR(cpu->regs[22], (SP + 32) + 8);
    goto L_e1ff4;
L_e2088:
    cpu->regs[19] = (uint64_t)(-(int64_t)cpu->regs[19]);
    cpu->regs[21] = cpu->regs[19] >> 30;
    if ((cpu->regs[21])!=0) goto L_e20d8;
    cpu->regs[0] = 1ULL;
    cpu->regs[30] = PB_BASE + 0xe209cULL; PB_CALL(3, cpu, tlb, PB_BASE + 0xe1608ULL);
    if ((cpu->regs[0])==0) goto L_e20e8;
    cpu->regs[1] = 10ULL;
    PB_STR((cpu->regs[0] + 16), cpu->regs[1]);
    PB_STRW((cpu->regs[0] + 24), cpu->regs[19]);
