...
void ft_PyImport_ExtendInittab(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 128ULL;
    ...
    PB_LDR(cpu->regs[0], (cpu->regs[2] + 1904));
    PB_LDR(cpu->regs[2], (cpu->regs[1] + 0));
    PB_STR((SP + 40), cpu->regs[2]);
    cpu->regs[2] = 0ULL;
    if ((cpu->regs[0])==0) goto L_96454;
    ...
    cpu->regs[30] = PB_BASE + 0x96454ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x91ebcULL);
L_96454:
    cpu->regs[24] = 0ULL;
L_96458:
    cpu->regs[21] = cpu->regs[24] << 4;
    PB_LDR(cpu->regs[0], (cpu->regs[25] + cpu->regs[21]));
    if ((cpu->regs[0])==0) goto L_9646c;
    cpu->regs[24] = cpu->regs[24] + 1ULL;
    goto L_96458;
L_9646c:
    if ((cpu->regs[24])==0) goto L_96578;
    cpu->regs[22] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[22], (cpu->regs[22] + 3200));
    cpu->regs[19] = 0ULL;
    PB_LDR(cpu->regs[0], (cpu->regs[22] + 0));
L_96480:
    cpu->regs[20] = cpu->regs[19] << 4;
    PB_LDR(cpu->regs[1], (cpu->regs[0] + cpu->regs[20]));
    if ((cpu->regs[1])==0) goto L_96494;
...
L_96494:
    ...
    cpu->regs[30] = PB_BASE + 0x964a4ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x17a7a8ULL);
    cpu->regs[23] = SP;
    cpu->regs[0] = 1152921504606846974ULL;
    FLAG_CMP(cpu->regs[19], cpu->regs[0]);
    if (FLAG_LS) goto L_964bc;
L_964b4:
    cpu->regs[20] = 4294967295ULL;
    goto L_96568;
L_964bc:
    cpu->regs[24] = PB_BASE + 0x5ac000ULL;
    cpu->regs[26] = cpu->regs[24] + 3792ULL;
    cpu->regs[19] = cpu->regs[19] + 1ULL;
    PB_LDR(cpu->regs[0], (cpu->regs[26] + 3808));
    cpu->regs[1] = cpu->regs[19] << 4;
    cpu->regs[30] = PB_BASE + 0x964d4ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0xd77c8ULL);
    cpu->regs[19] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_964b4;
    PB_LDR(cpu->regs[1], (cpu->regs[22] + 0));
    PB_LDR(cpu->regs[0], (cpu->regs[26] + 3808));
    FLAG_CMP(cpu->regs[0], cpu->regs[1]);
    if (FLAG_EQ) goto L_96520;
    cpu->regs[2] = cpu->regs[20] + 16ULL;
    FLAG_CMP(cpu->regs[1], cpu->regs[19]);
    if (FLAG_LS) goto L_96508;
    cpu->regs[0] = cpu->regs[19] + cpu->regs[2];
    FLAG_CMP(cpu->regs[1], cpu->regs[0]);
    if (FLAG_HS) goto L_96518;
L_96504:
    __builtin_trap();
L_96508:
    if (FLAG_HS) goto L_96518;
    ...
    FLAG_CMP(cpu->regs[19], cpu->regs[0]);
    if (FLAG_LO) goto L_96504;
L_96518:
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0x96520ULL; PB_CALL(4, cpu, tlb, PB_BASE + 0x7c090ULL);
L_96520:
    cpu->regs[0] = cpu->regs[19] + cpu->regs[20];
    cpu->regs[2] = cpu->regs[21] + 16ULL;
    FLAG_CMP(cpu->regs[0], cpu->regs[25]);
    if (FLAG_HS) goto L_96540;
    cpu->regs[1] = cpu->regs[0] + cpu->regs[2];
    FLAG_CMP(cpu->regs[25], cpu->regs[1]);
    if (FLAG_HS) goto L_96550;
    goto L_96504;
L_96540:
    if (FLAG_LS) goto L_96550;
    cpu->regs[1] = cpu->regs[25] + cpu->regs[2];
    FLAG_CMP(cpu->regs[0], cpu->regs[1]);
    if (FLAG_LO) goto L_96504;
L_96550:
    ...
    cpu->regs[20] = 0ULL;
    cpu->regs[30] = PB_BASE + 0x96560ULL; PB_CALL(5, cpu, tlb, PB_BASE + 0x7c090ULL);
    PB_STR((cpu->regs[22] + 0), cpu->regs[19]);
    PB_STR((cpu->regs[24] + 3808), cpu->regs[19]);
L_96568:
    cpu->regs[1] = cpu->regs[23];
    cpu->regs[0] = 0ULL;
    cpu->regs[30] = PB_BASE + 0x96574ULL; PB_CALL(6, cpu, tlb, PB_BASE + 0x17ac80ULL);
    goto L_9657c;
L_96578:
    cpu->regs[20] = 0ULL;
L_9657c:
    ...
    cpu->regs[1] = 0ULL;
    if (FLAG_EQ) goto L_9659c;
    cpu->regs[30] = PB_BASE + 0x9659cULL; PB_CALL(7, cpu, tlb, PB_BASE + 0x7c170ULL);
L_9659c:
