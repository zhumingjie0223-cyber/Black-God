...
L_120750:
    ...
    cpu->regs[5] = 0ULL;
    cpu->regs[3] = 0ULL;
    cpu->regs[30] = PB_BASE + 0x120760ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x11ae68ULL);
...
L_12079c:
    ...
    if (FLAG_HS) goto L_120738;
L_1207a8:
    PB_LDR(cpu->regs[0], (cpu->regs[19] + 0));
    if ((cpu->regs[0])==0) goto L_1207d4;
L_1207b0:
    cpu->regs[1] = cpu->regs[21];
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0x1207bcULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x11cba0ULL);
    FLAG_CMP(cpu->regs[0], (uint64_t)(-(int64_t)(1ULL)));
    if (FLAG_EQ) goto L_12081c;
    PB_LDR(cpu->regs[0], (cpu->regs[19] + 0));
    cpu->regs[2] = cpu->regs[20];
...
L_1207d4:
    ...
    if ((((uint32_t)(cpu->regs[0])))!=0) goto L_1207b0;
    cpu->regs[0] = 1ULL;
    PB_STRB((cpu->regs[19] + 53), cpu->regs[0]);
    PB_LDRW(cpu->regs[0], (cpu->regs[20] + 0));
    cpu->regs[0] = ((uint32_t)(cpu->regs[0] + 1ULL)); FLAG_CMP(cpu->regs[0], 0);
    if (FLAG_EQ) goto L_1207f4;
    PB_STRW((cpu->regs[20] + 0), cpu->regs[0]);
L_1207f4:
    PB_STR((cpu->regs[19] + 0), cpu->regs[20]);
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0x120800ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x1a1e64ULL);
    PB_LDR(cpu->regs[1], (cpu->regs[19] + 32));
