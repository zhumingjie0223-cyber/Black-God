...
void ft__Py_NewReference(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    { PB_CALL(1, cpu, tlb, PB_BASE + 0x187e20ULL); return; };
    ...
    cpu->regs[30] = PB_BASE + 0xd9464ULL; PB_CALL(2, cpu, tlb, cpu->regs[3]);
    ...
    PB_STR((cpu->regs[1] + -16), cpu->regs[2]); PB_STR((cpu->regs[1] + -16) + 8, cpu->regs[0]);
