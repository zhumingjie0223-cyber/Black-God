...
void ft_PyUnicodeDecodeError_GetEncoding(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    { PB_CALL(1, cpu, tlb, PB_BASE + 0x7b200ULL); return; };
    /* nop */
    /* nop */
    /* nop */
    ...
    PB_LDRB(cpu->regs[1], (cpu->regs[3] + cpu->regs[1]));
    FLAG_CMP(((uint32_t)(cpu->regs[1])), ((uint32_t)(117ULL)));
    if (FLAG_NE) goto L_24e380;
...
L_24e28c:
    ...
    if (FLAG_EQ) goto L_24e310;
    FLAG_CMP(((uint32_t)(cpu->regs[0])), ((uint32_t)(51ULL)));
    if (FLAG_NE) goto L_24e300;
    PB_LDRB(cpu->regs[0], (cpu->regs[2] + 1));
    ...
    if ((((uint32_t)(cpu->regs[1])))==0) goto L_24e280;
    FLAG_CMP(((uint32_t)(cpu->regs[1])), ((uint32_t)(45ULL)));
    ...
    if ((((uint32_t)(cpu->regs[0])))!=0) goto L_24e300;
    PB_LDRB(cpu->regs[0], (cpu->regs[2] + 0));
    PB_LDRB(cpu->regs[1], (cpu->regs[3] + cpu->regs[0]));
    FLAG_CMP(((uint32_t)(cpu->regs[1])), ((uint32_t)(98ULL)));
    if (FLAG_EQ) goto L_24e308;
    cpu->regs[0] = 4ULL;
    FLAG_CMP(((uint32_t)(cpu->regs[1])), ((uint32_t)(108ULL)));
    if (FLAG_EQ) goto L_24e280;
L_24e300:
...
L_24e380:
    ...
    cpu->regs[30] = PB_BASE + 0x24e38cULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x7ae60ULL);
    if ((((uint32_t)(cpu->regs[0])))==0) goto L_24e274;
    cpu->regs[0] = 4294967295ULL;
    goto L_24e280;
    /* nop */
    /* nop */
