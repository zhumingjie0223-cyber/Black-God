...
L_1c4a30:
    ...
    cpu->regs[30] = PB_BASE + 0x1c4a40ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x9bb50ULL);
    cpu->regs[0] = 0ULL;
    goto L_1c4a28;
L_1c4a48:
    ...
    cpu->regs[30] = PB_BASE + 0x1c4a68ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1d2ec0ULL);
    cpu->regs[0] = 0ULL;
    goto L_1c4a28;
}
