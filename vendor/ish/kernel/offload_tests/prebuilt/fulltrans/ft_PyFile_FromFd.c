...
void ft_PyFile_FromFd(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 96ULL;
    ...
    cpu->regs[25] = cpu->regs[6];
    cpu->regs[26] = cpu->regs[7];
    cpu->regs[30] = PB_BASE + 0xc8a58ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x1c5aa0ULL);
    cpu->regs[19] = cpu->regs[0];
    if ((cpu->regs[0])==0) goto L_c8ac4;
    ...
    cpu->regs[1] = cpu->regs[1] + 672ULL;
    cpu->regs[30] = PB_BASE + 0xc8aa0ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1c1960ULL);
    PB_LDR(cpu->regs[1], (cpu->regs[19] + 0));
    cpu->regs[20] = cpu->regs[0];
    if (((cpu->regs[1] >> 31) & 1)) goto L_c8ac0;
    cpu->regs[1] = cpu->regs[1] - 1ULL;
    PB_STR((cpu->regs[19] + 0), cpu->regs[1]);
    if ((cpu->regs[1])!=0) goto L_c8ac0;
    cpu->regs[0] = cpu->regs[19];
    cpu->regs[30] = PB_BASE + 0xc8ac0ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0xdcac8ULL);
L_c8ac0:
