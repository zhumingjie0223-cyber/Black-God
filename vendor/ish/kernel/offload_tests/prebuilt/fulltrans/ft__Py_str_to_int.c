...
void ft__Py_str_to_int(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 64ULL;
...
L_90384:
    ...
    cpu->regs[2] = 0ULL;
    if (FLAG_EQ) goto L_903a4;
    cpu->regs[30] = PB_BASE + 0x903a4ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x7c170ULL);
L_903a4:
