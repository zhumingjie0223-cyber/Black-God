...
void ft_PyStaticMethod_New(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x18d690ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0xde828ULL);
    if ((cpu->regs[0])==0) goto L_18d6a8;
    PB_LDRW(cpu->regs[1], (cpu->regs[19] + 0));
    cpu->regs[1] = ((uint32_t)(cpu->regs[1] + 1ULL)); FLAG_CMP(cpu->regs[1], 0);
    if (FLAG_EQ) goto L_18d6a4;
...
L_18d6a8:
    ...
    if (FLAG_NE) goto L_18d73c;
    if ((cpu->regs[2])==0) goto L_18d754;
    PB_LDRW(cpu->regs[3], (cpu->regs[0] + 32));
    PB_LDRW(cpu->regs[4], (cpu->regs[1] + 32));
    cpu->regs[3] = ((uint32_t)(cpu->regs[3] ^ cpu->regs[4]));
    FLAG_CMP((((uint32_t)(cpu->regs[3]))) & (((uint32_t)(28ULL))), 0);
    if (FLAG_NE) goto L_18d73c;
    SP += -16; PB_STR(SP, cpu->regs[29]); PB_STR(SP + 8, cpu->regs[30]);
    cpu->regs[29] = SP;
    PB_LDR(cpu->regs[3], (cpu->regs[0] + 32));
    if (!((cpu->regs[3] >> 5) & 1)) goto L_18d74c;
    cpu->regs[4] = cpu->regs[0] + 40ULL;
    FLAG_CMP((((uint32_t)(cpu->regs[3]))) & (((uint32_t)(64ULL))), 0);
    cpu->regs[0] = cpu->regs[0] + 56ULL;
    cpu->regs[0] = (FLAG_EQ) ? cpu->regs[0] : cpu->regs[4];
L_18d708:
    PB_LDR(cpu->regs[4], (cpu->regs[1] + 32));
    if (!((cpu->regs[4] >> 5) & 1)) goto L_18d744;
    FLAG_CMP((((uint32_t)(cpu->regs[4]))) & (((uint32_t)(64ULL))), 0);
    cpu->regs[4] = cpu->regs[1] + 40ULL;
...
L_18d720:
    ...
    cpu->regs[30] = PB_BASE + 0x18d72cULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x7ab70ULL);
...
L_18d754:
    ...
    return;
    /* nop */
    if ((cpu->regs[0])==0) goto L_18d778;
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 0));
    if (((cpu->regs[2] >> 31) & 1)) goto L_18d778;
    cpu->regs[2] = cpu->regs[2] - 1ULL;
    PB_STR((cpu->regs[0] + 0), cpu->regs[2]);
    if ((cpu->regs[2])==0) goto L_18d77c;
L_18d778:
    return;
L_18d77c:
