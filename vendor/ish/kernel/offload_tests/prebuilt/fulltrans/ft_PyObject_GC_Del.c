...
void ft_PyObject_GC_Del(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
...
L_e1e20:
    ...
    PB_STRW((cpu->regs[0] + 44), cpu->regs[3]);
...
L_e1e4c:
    ...
    cpu->regs[0] = cpu->regs[0] + 2160ULL;
    cpu->regs[30] = PB_BASE + 0xe1e60ULL; PB_CALL(2, cpu, tlb, cpu->regs[5]);
    ...
    PB_STR((cpu->regs[3] + 8), cpu->regs[4]);
    cpu->regs[0] = cpu->regs[0] + 112ULL;
    PB_LDRW(cpu->regs[3], (cpu->regs[0] + 44));
    PB_STR((cpu->regs[1] + -16), 0ULL);
    FLAG_CMP(((uint32_t)(cpu->regs[3])), ((uint32_t)(0ULL)));
    if (FLAG_GT) goto L_e1e20;
L_e1e98:
    cpu->regs[0] = PB_BASE + 0x44f000ULL;
