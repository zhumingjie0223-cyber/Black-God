...
void ft__PyErr_GetExcInfo(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
...
L_8f180:
    ...
    if ((cpu->regs[0])==0) goto L_8f190;
    FLAG_CMP(cpu->regs[0], cpu->regs[5]);
    if (FLAG_NE) goto L_8f1b4;
L_8f190:
    PB_LDR(cpu->regs[3], (cpu->regs[4] + 8));
    if ((cpu->regs[3])==0) goto L_8f1a0;
    cpu->regs[4] = cpu->regs[3];
    goto L_8f180;
L_8f1a0:
    cpu->regs[3] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[3], (cpu->regs[3] + 2760));
    if ((cpu->regs[0])==0) goto L_8f1c0;
    FLAG_CMP(cpu->regs[0], cpu->regs[3]);
    if (FLAG_EQ) goto L_8f1c4;
L_8f1b4:
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 8));
    if ((cpu->regs[0])!=0) goto L_8f1c4;
    goto L_8f1d4;
L_8f1c0:
...
L_8f1c4:
    ...
    if (FLAG_EQ) goto L_8f1d4;
    PB_STRW((cpu->regs[0] + 0), cpu->regs[5]);
L_8f1d4:
    PB_STR((cpu->regs[1] + 0), cpu->regs[0]);
    PB_LDR(cpu->regs[0], (cpu->regs[4] + 0));
    if ((cpu->regs[0])==0) goto L_8f1f0;
    PB_LDRW(cpu->regs[1], (cpu->regs[0] + 0));
    cpu->regs[1] = ((uint32_t)(cpu->regs[1] + 1ULL)); FLAG_CMP(cpu->regs[1], 0);
    if (FLAG_EQ) goto L_8f1f0;
    PB_STRW((cpu->regs[0] + 0), cpu->regs[1]);
L_8f1f0:
    PB_STR((cpu->regs[2] + 0), cpu->regs[0]);
    PB_LDR(cpu->regs[0], (cpu->regs[4] + 0));
    cpu->regs[30] = PB_BASE + 0x8f1fcULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x2324a8ULL);
    PB_LDRW(cpu->regs[1], (cpu->regs[0] + 0));
    cpu->regs[1] = ((uint32_t)(cpu->regs[1] + 1ULL)); FLAG_CMP(cpu->regs[1], 0);
    if (FLAG_EQ) goto L_8f20c;
    PB_STRW((cpu->regs[0] + 0), cpu->regs[1]);
L_8f20c:
