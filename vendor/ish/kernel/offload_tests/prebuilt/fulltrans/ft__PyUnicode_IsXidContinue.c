...
void ft__PyUnicode_IsXidContinue(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP += -16; PB_STR(SP, cpu->regs[29]); PB_STR(SP + 8, cpu->regs[30]);
    cpu->regs[29] = SP;
    cpu->regs[30] = PB_BASE + 0x1ac4b4ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x10a220ULL);
    PB_LDRH(cpu->regs[0], (cpu->regs[0] + 14));
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 16;
    cpu->regs[0] = ((cpu->regs[0] >> 9) & 0x1ULL);
    return;
...
L_1ac504:
    ...
    cpu->regs[30] = PB_BASE + 0x1ac510ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0xd7ea0ULL);
    cpu->regs[2] = cpu->regs[0];
    PB_LDR(cpu->regs[1], (SP + 40));
    FLAG_CMP(cpu->regs[0], (uint64_t)(-(int64_t)(1ULL)));
    if (FLAG_NE) goto L_1ac4f4;
    PB_LDR(cpu->regs[19], (SP + 16));
    PB_LDR(cpu->regs[29], SP); PB_LDR(cpu->regs[30], SP + 8); SP += 48;
    return;
L_1ac52c:
    ...
    PB_STR((SP + 16), cpu->regs[19]);
    cpu->regs[19] = cpu->regs[0];
    cpu->regs[30] = PB_BASE + 0x1ac540ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x12b728ULL);
    if ((cpu->regs[0])==0) goto L_1ac5a4;
    cpu->regs[1] = cpu->regs[0];
    cpu->regs[0] = 0ULL;
    PB_LDR(cpu->regs[2], (cpu->regs[1] + 0));
    if ((cpu->regs[2])!=0) goto L_1ac560;
L_1ac554:
    PB_LDR(cpu->regs[19], (SP + 16));
...
L_1ac560:
    ...
    cpu->regs[0] = cpu->regs[0] + 1784ULL;
    cpu->regs[5] = 18446744073709551615ULL;
    PB_STR((cpu->regs[1] + 0), cpu->regs[0]); PB_STR((cpu->regs[1] + 0) + 8, cpu->regs[5]);
    cpu->regs[0] = cpu->regs[4] + cpu->regs[5];
    PB_STR((cpu->regs[19] + 24), cpu->regs[0]);
    if (((cpu->regs[3] >> 31) & 1)) goto L_1ac59c;
    cpu->regs[3] = cpu->regs[3] + cpu->regs[5];
    PB_STR((cpu->regs[2] + 0), cpu->regs[3]);
    if ((cpu->regs[3])!=0) goto L_1ac59c;
    cpu->regs[0] = cpu->regs[2];
    cpu->regs[30] = PB_BASE + 0x1ac59cULL; PB_CALL(4, cpu, tlb, PB_BASE + 0xdcac8ULL);
L_1ac59c:
    cpu->regs[0] = 1ULL;
    goto L_1ac554;
L_1ac5a4:
    ...
    if (!((cpu->regs[2] >> 5) & 1)) goto L_1ac5cc;
