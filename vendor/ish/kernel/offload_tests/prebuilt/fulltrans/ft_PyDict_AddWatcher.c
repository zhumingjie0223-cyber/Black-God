...
void ft_PyDict_AddWatcher(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x94184ULL; PB_CALL(1, cpu, tlb, cpu->regs[1]);
    PB_LDR(cpu->regs[0], (cpu->regs[4] + cpu->regs[0]));
    cpu->regs[1] = 0ULL;
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 16));
    cpu->regs[0] = cpu->regs[2] + (66ULL << 12);
    cpu->regs[0] = cpu->regs[0] + 1688ULL;
L_94198:
    PB_LDR(cpu->regs[4], (cpu->regs[0] + (cpu->regs[1] << 3)));
    if ((cpu->regs[4])!=0) goto L_941b8;
    cpu->regs[2] = cpu->regs[2] + (((uint64_t)(int64_t)(int32_t)(cpu->regs[1])) << 3);
    cpu->regs[0] = cpu->regs[1];
    cpu->regs[2] = cpu->regs[2] + (66ULL << 12);
