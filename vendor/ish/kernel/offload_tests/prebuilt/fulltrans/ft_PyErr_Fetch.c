...
void ft_PyErr_Fetch(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x1e6844ULL; PB_CALL(1, cpu, tlb, cpu->regs[5]);
    ...
    { PB_CALL(2, cpu, tlb, PB_BASE + 0x1e6860ULL); return; };
}
