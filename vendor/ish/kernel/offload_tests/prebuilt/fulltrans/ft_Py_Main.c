...
void ft_Py_Main(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 64ULL;
    ...
    PB_STRW((SP + 16), 0ULL);
    PB_STR((SP + 24), 0ULL); PB_STR((SP + 24) + 8, cpu->regs[1]);
    cpu->regs[30] = PB_BASE + 0xd702cULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x17a040ULL);
    ...
    cpu->regs[2] = 0ULL;
    if (FLAG_EQ) goto L_d704c;
    cpu->regs[30] = PB_BASE + 0xd704cULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x7c170ULL);
L_d704c:
