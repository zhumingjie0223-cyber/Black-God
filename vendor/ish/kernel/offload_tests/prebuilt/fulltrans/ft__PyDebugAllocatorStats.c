...
void ft__PyDebugAllocatorStats(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 336ULL;
    ...
    cpu->regs[22] = SP + 136ULL;
    cpu->regs[3] = cpu->regs[2];
    PB_STR((SP + 320), cpu->regs[23]);
    ...
    cpu->regs[0] = 0ULL;
    cpu->regs[2] = cpu->regs[2] + 3928ULL;
    cpu->regs[0] = cpu->regs[22];
    cpu->regs[30] = PB_BASE + 0x8fa0cULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x1815f0ULL);
    cpu->regs[3] = cpu->regs[22];
    cpu->regs[1] = 128ULL;
    cpu->regs[0] = cpu->regs[21];
    cpu->regs[2] = PB_BASE + 0x2a0000ULL;
    cpu->regs[2] = cpu->regs[2] + 3952ULL;
    cpu->regs[30] = PB_BASE + 0x8fa24ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1815f0ULL);
    cpu->regs[2] = ((uint64_t)(int64_t)(int32_t)(cpu->regs[19]));
    cpu->regs[1] = cpu->regs[21];
    cpu->regs[0] = cpu->regs[23];
    cpu->regs[2] = cpu->regs[2] * cpu->regs[20];
    cpu->regs[30] = PB_BASE + 0x8fa38ULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x8645cULL);
    ...
    cpu->regs[1] = 0ULL;
    if (FLAG_EQ) goto L_8fa58;
    cpu->regs[30] = PB_BASE + 0x8fa58ULL; PB_CALL(4, cpu, tlb, PB_BASE + 0x7c170ULL);
L_8fa58:
    PB_LDR(cpu->regs[23], (SP + 320));
