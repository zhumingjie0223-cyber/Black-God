...
void ft_PyNumber_Or(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    ...
    cpu->regs[30] = PB_BASE + 0x14e49cULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x11a7a0ULL);
    cpu->regs[2] = PB_BASE + 0x44f000ULL;
    PB_LDR(cpu->regs[2], (cpu->regs[2] + 2400));
    FLAG_CMP(cpu->regs[0], cpu->regs[2]);
    if (FLAG_EQ) goto L_14e4b8;
L_14e4ac:
...
L_14e4b8:
    ...
    cpu->regs[2] = 120ULL;
    cpu->regs[3] = cpu->regs[3] + 1088ULL;
    cpu->regs[30] = PB_BASE + 0x14e4d0ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x1b02c0ULL);
    cpu->regs[0] = 0ULL;
    goto L_14e4ac;
    /* nop */
    /* nop */
...
L_14e584:
    { PB_CALL(5, cpu, tlb, PB_BASE + 0x169eacULL); return; };
L_14e588:
