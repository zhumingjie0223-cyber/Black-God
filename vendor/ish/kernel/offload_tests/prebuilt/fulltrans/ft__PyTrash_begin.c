...
void ft__PyTrash_begin(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    if ((cpu->regs[0])==0) goto L_dcdf4;
    PB_LDRW(cpu->regs[3], (cpu->regs[0] + 152));
    cpu->regs[2] = cpu->regs[0] + 152ULL;
    FLAG_CMP(((uint32_t)(cpu->regs[3])), ((uint32_t)(49ULL)));
    if (FLAG_GT) goto L_dcdd4;
...
L_dcdf4:
    ...
    cpu->regs[30] = PB_BASE + 0xdce04ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x7c39cULL);
    PB_LDRW(cpu->regs[3], (cpu->regs[0] + 0));
    cpu->regs[2] = cpu->regs[0];
    PB_LDR(cpu->regs[1], (SP + 24));
    FLAG_CMP(((uint32_t)(cpu->regs[3])), ((uint32_t)(49ULL)));
    if (FLAG_GT) goto L_dce2c;
    cpu->regs[3] = ((uint32_t)(cpu->regs[3] + 1ULL));
    cpu->regs[0] = 0ULL;
    PB_STRW((cpu->regs[2] + 0), cpu->regs[3]);
L_dce24:
...
L_dce2c:
    ...
    PB_STR((cpu->regs[2] + 8), cpu->regs[1]);
    goto L_dce24;
    if ((cpu->regs[0])==0) goto L_dce58;
    PB_LDR(cpu->regs[2], (cpu->regs[0] + 0));
    if (!((cpu->regs[2] >> 31) & 1)) goto L_dce5c;
L_dce58:
    return;
L_dce5c:
    cpu->regs[2] = cpu->regs[2] - 1ULL;
    PB_STR((cpu->regs[0] + 0), cpu->regs[2]);
    if ((cpu->regs[2])!=0) goto L_dce58;
