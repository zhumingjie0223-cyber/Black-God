...
void ft__PyEval_SliceIndex(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
...
L_146af0:
    ...
    cpu->regs[30] = PB_BASE + 0x146b0cULL; PB_CALL(3, cpu, tlb, PB_BASE + 0x1d5980ULL);
    cpu->regs[0] = 0ULL;
    goto L_146ad0;
L_146b14:
    PB_LDR(cpu->regs[0], (cpu->regs[0] + 8));
    if ((cpu->regs[0])==0) goto L_146ae4;
    cpu->regs[0] = 0ULL;
    goto L_146ad0;
}
