...
void ft_Py_PreInitializeFromArgs(struct cpu_state *cpu, struct tlb *tlb) {
(void)tlb;(void)cpu;
    SP = SP - 64ULL;
    ...
    PB_STR((SP + 32), cpu->regs[2]);
    cpu->regs[30] = PB_BASE + 0x96970ULL; PB_CALL(1, cpu, tlb, PB_BASE + 0x17ad8cULL);
    ...
    cpu->regs[1] = 0ULL;
    if (FLAG_EQ) goto L_96990;
    cpu->regs[30] = PB_BASE + 0x96990ULL; PB_CALL(2, cpu, tlb, PB_BASE + 0x7c170ULL);
L_96990:
