...
1.3.0（12）发布候选包含尚未上架的可靠性修复与界面重构，已配置 iPhone／iPad 双设备族并实现原生 iPad 侧栏；本轮 iPhone／iPad 模拟器验证以及 iPhone 安装、启动、聊天保留检查已完成，完整真机／模型验收仍待完成，尚未上架本轮改动。当前交付门槛见 [工业级验收门槛](docs/quality/工业级验收门槛.md)。
