...
// 私密 API 集合源码级核对：与 nexus_do.core.mjs 当前定义逐一比对，没被静默删项。
{
  ...
  const EXPECTED_PRIVATE_PATHS = ['/talk', '/soul', '/soul/continuity', '/inner', '/lexicon', '/heartbeat', '/device', '/image', '/voice', '/video', '/migrate', '/whoami', '/subscribe', '/push-test', '/agent', '/config', '/exec-test', '/loop', '/wsticket', '/stats'];
